    ...
    <div className="antialiased min-h-screen relative overflow-x-hidden">
      ...
      <main className="relative z-10 pt-28 pb-32 px-4 md:px-8 max-w-3xl mx-auto">
        ...
        <div className="mb-8 relative">
          ...
          <h2 className="text-3xl font-bold text-on-surface mb-2 tracking-tight">My Records</h2>
          <p className="text-on-surface-variant text-base mb-6 leading-relaxed">Access and manage your complete medical history in one secure place.</p>
          ...
          <div className="flex gap-3 items-center">
            <div className="flex-1 bg-surface-container-highest rounded-[1.5rem] px-5 py-4 flex items-center gap-3 transition-colors focus-within:bg-surface-container-low focus-within:ring-2 focus-within:ring-primary/10">
              ...
              <input className="bg-transparent border-none outline-none text-on-surface w-full placeholder:text-outline placeholder:font-medium text-base" placeholder="Search records, dates, or doctors..." type="text" />
            </div>
        ...
        <div className="space-y-8">
          {/* Group: This Month */}
          <section>
            <h3 className="text-[0.6875rem] font-bold uppercase tracking-[0.05em] text-on-surface-variant mb-4 px-2">October 2023</h3>
            <div className="space-y-3">
              ...
              <div className="bg-surface-container-lowest rounded-[1.5rem] p-4 flex items-center gap-4 hover:-translate-y-1 transition-transform duration-300">
                ...
                <div className="flex-1 min-w-0">
                  <h4 className="text-on-surface font-semibold text-lg truncate">Comprehensive Blood Panel</h4>
                  <p className="text-on-surface-variant text-sm mt-0.5 truncate">Dr. Sarah Jenkins • Lab Report</p>
                </div>
                <div className="text-right shrink-0">
                  <p className="text-on-surface-variant text-sm font-medium mb-1">Oct 24</p>
              ...
              <div className="bg-surface-container-lowest rounded-[1.5rem] p-4 flex items-center gap-4 hover:-translate-y-1 transition-transform duration-300">
                ...
                <div className="flex-1 min-w-0">
                  <h4 className="text-on-surface font-semibold text-lg truncate">Chest X-Ray Scans</h4>
                  <p className="text-on-surface-variant text-sm mt-0.5 truncate">City General Hospital • Radiology</p>
                </div>
                <div className="text-right shrink-0">
                  <p className="text-on-surface-variant text-sm font-medium mb-1">Oct 12</p>
          ...
          <section>
            <h3 className="text-[0.6875rem] font-bold uppercase tracking-[0.05em] text-on-surface-variant mb-4 px-2">September 2023</h3>
            <div className="space-y-3">
              {/* Record Item */}
              <div className="bg-surface-container-lowest rounded-[1.5rem] p-4 flex items-center gap-4 hover:-translate-y-1 transition-transform duration-300">
                <div className="w-12 h-12 rounded-xl bg-surface-container-low flex items-center justify-center text-secondary shrink-0 relative overflow-hidden">
                ...
                <div className="flex-1 min-w-0">
                  <h4 className="text-on-surface font-semibold text-lg truncate">Annual Physical Summary</h4>
                  <p className="text-on-surface-variant text-sm mt-0.5 truncate">Dr. Robert Chen • General Practice</p>
                </div>
                <div className="text-right shrink-0">
                  <p className="text-on-surface-variant text-sm font-medium mb-1">Sep 05</p>
                  <span className="text-[0.6875rem] font-bold uppercase tracking-wider text-primary bg-primary-fixed px-2 py-1 rounded-md">PDF</span>
                </div>
              </div>
              ...
              <div className="bg-surface-container-lowest rounded-[1.5rem] p-4 flex items-center gap-4 hover:-translate-y-1 transition-transform duration-300">
                ...
                <div className="flex-1 min-w-0">
                  <h4 className="text-on-surface font-semibold text-lg truncate">Vaccination Record</h4>
                  <p className="text-on-surface-variant text-sm mt-0.5 truncate">Pharmacy Plus • Immunization</p>
                </div>
                <div className="text-right shrink-0">
                  <p className="text-on-surface-variant text-sm font-medium mb-1">Sep 01</p>
                  <span className="text-[0.6875rem] font-bold uppercase tracking-wider text-primary bg-primary-fixed px-2 py-1 rounded-md">PDF</span>
                </div>
              </div>
            </div>
        ...
        {/* Floating Add Button (Contextual for Vault) */}
