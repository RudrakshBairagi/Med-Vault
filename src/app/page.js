export default function Home() {
  return (
    <>
      ...
      <main className="px-6 pt-6 pb-24 max-w-4xl mx-auto space-y-12">
        {/* Greeting */}
        <section className="pt-8 pb-4 mb-12 relative">
          ...
          <h1 className="leading-none tracking-[-0.02em] font-extrabold text-on-surface mb-2 text-[3.5rem]">
            Hallo <br /> <span className="text-primary italic font-serif font-medium relative z-10">Julian.</span>
          </h1>
          <p className="text-lg text-on-surface-variant max-w-md leading-relaxed mt-4">
            Your vitality looks excellent today. Here is your curated wellness overview.
          </p>
        </section>
        ...
        <section className="grid grid-cols-2 gap-4">
          ...
          <button className="bg-secondary-container rounded-xl p-6 flex flex-col justify-between items-start aspect-square relative overflow-hidden group hover:opacity-90 transition-opacity">
            ...
            <div className="text-left mt-auto z-10">
              <h3 className="text-lg font-bold text-on-secondary-container">Upload New</h3>
              <p className="text-sm text-on-secondary-container/80 mt-1">Add to vault</p>
            </div>
            {/* Organic shape */}
          ...
          <button className="bg-primary-container rounded-xl p-6 flex flex-col justify-between items-start aspect-square relative overflow-hidden group hover:opacity-90 transition-opacity">
            ...
            <div className="text-left mt-auto z-10">
              <h3 className="text-lg font-bold text-on-primary">View Vault</h3>
              <p className="text-sm text-on-primary-container mt-1">Access records</p>
            </div>
            {/* Organic shape */}
        ...
        <section className="space-y-4">
          <div className="flex justify-between items-end">
            <h2 className="text-[1.125rem] font-medium text-on-surface">Medicine Tracker</h2>
          ...
          <div className="space-y-3">
            ...
            <div className="bg-surface-container-lowest rounded-xl p-4 shadow-[0_4px_20px_rgba(26,28,23,0.02)] flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="font-bold text-on-surface">Lisinopril</h3>
                  <p className="text-sm text-on-surface-variant">10mg • After breakfast</p>
                </div>
              </div>
            ...
            <div className="bg-surface-container-lowest rounded-xl p-4 shadow-[0_4px_20px_rgba(26,28,23,0.02)] flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="font-bold text-on-surface">Vitamin D3</h3>
                  <p className="text-sm text-on-surface-variant">5000 IU • With dinner</p>
                </div>
              </div>
        ...
        <section className="space-y-4">
          <h2 className="text-[1.125rem] font-medium text-on-surface">Next Visit</h2>
          <div className="flex overflow-x-auto gap-4 pb-4 -mx-6 px-6 snap-x hide-scrollbar">
            ...
            <div className="min-w-[280px] bg-surface-container-lowest rounded-xl p-6 shadow-[0_4px_20px_rgba(26,28,23,0.02)] snap-center relative overflow-hidden flex flex-col justify-between min-h-[160px]">
              <div className="flex justify-between items-start mb-4">
                ...
                <span className="text-[0.6875rem] uppercase tracking-[0.05em] font-bold text-on-surface-variant">Upcoming</span>
              </div>
              <div>
                <h3 className="text-lg font-bold text-on-surface">Dr. Sarah Jenkins</h3>
                <p className="text-sm text-on-surface-variant mt-1">General Checkup • 10:00 AM</p>
              </div>
            </div>
            ...
            <div className="min-w-[280px] bg-surface-container-low rounded-xl p-6 shadow-[0_4px_20px_rgba(26,28,23,0.02)] snap-center relative overflow-hidden flex flex-col justify-between min-h-[160px]">
              <div className="flex justify-between items-start mb-4">
                ...
                <span className="text-[0.6875rem] uppercase tracking-[0.05em] font-bold text-on-surface-variant">Pending</span>
              </div>
              <div>
                <h3 className="text-lg font-bold text-on-surface">Lab Results</h3>
                <p className="text-sm text-on-surface-variant mt-1">Blood panel • Expected Tomorrow</p>
              </div>
            </div>
          </div>
        </section>
      ...
      <nav className="bg-[#fafaf1]/80 backdrop-blur-xl text-[#01261f] font-['Plus_Jakarta_Sans'] text-[11px] font-bold uppercase tracking-widest fixed bottom-0 left-0 w-full rounded-t-[2.5rem] z-50 no-border shadow-[0_-4px_40px_rgba(26,28,23,0.05)] hover:text-[#01261f] transition-colors flex justify-around items-center px-8 pb-8 pt-4">
        {/* Active Tab: Home */}
        <a className="flex flex-col items-center justify-center text-[#01261f] relative after:content-[''] after:absolute after:-bottom-1 after:w-1 after:h-1 after:bg-[#f6e232] after:rounded-full group" href="#">
